...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0xaa,0xbb,0xcc,0xdd,0xee}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0xaa,0xbb,0xcc,0xdd,0xee};
...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7;	//PG8 7 推挽 	  
